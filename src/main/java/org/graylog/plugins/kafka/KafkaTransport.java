...
public class KafkaTransport extends ThrottleableTransport {
    ...
    public static class Config extends ThrottleableTransport.Config {
        ...
        public ConfigurationRequest getRequestedConfiguration() {
            ...
            cr.addField(new BooleanField(
                    CK_SSL_ALLOWED,
                    "Allow ssl communication with kafka broker.",
                    false,
            ...
            cr.addField(
                    new TextField(
                            CK_TLS_CLIENT_PASSWORD_TRUSTED_STORE,
                            "Trust store password config",
                            "",
    ...
    public class KafkaConsumerRunner implements Runnable {
        ...
        private String deserialize(final byte[] objectData) {
            try {
